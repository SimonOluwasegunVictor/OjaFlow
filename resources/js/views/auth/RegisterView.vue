...
<template>
  <AuthShell>
    ...
    <form class="auth-card" @submit.prevent="submit">
      <div>
        <h2 class="text-2xl font-black text-slate-950">Create your account</h2>
        <p class="mt-2 text-sm font-medium text-slate-500">Get started with OjaFlow for free</p>
      </div>
      ...
      <p v-if="form.password && form.confirm_password && form.password !== form.confirm_password" class="mt-4 rounded-lg bg-amber-50 px-3 py-2 text-sm font-semibold text-amber-800">
      ...
      <p class="mt-5 text-center text-xs font-medium text-slate-400">By signing up, you agree to our Terms of Service</p>
    </form>
  </AuthShell>
</template>
